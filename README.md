...
このシステムは、NT函館mini 2026のために作成されました
...
* **モータードライバ:** [DRV8835使用ステッピング&DCモータードライバーモジュール](https://akizukidenshi.com/catalog/g/g109848/)
* **赤外線送信:** 赤外線LED
* **赤外線受信:** [PL-IRM0101](https://akizukidenshi.com/catalog/g/g100622/)

## ソフトウェア仕様

注: LLMが書いたので、不正確な箇所があるかもしれません。
